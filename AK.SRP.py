...
df=pd.read_csv(r"C:\Users\HP\Sing\final_csv")
...
with tab3:
    ...
    if st.button('Predict and Conclusion'):
            ...
            def load_data():
                # Load data
                data = pd.read_csv(r"C:\Users\HP\Sing\final_csv")
                sample_df = data.sample(n=5000, random_state=11)
                return sample_df
